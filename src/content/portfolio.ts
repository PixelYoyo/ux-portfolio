...
export const hero = {
  ...
  profileImageSrc: 'https://res.cloudinary.com/drd6p33en/image/upload/q_auto:best,f_auto/v1778497163/Profile_photo_sfjaho.png',
...
export const featuredWork = {
  featured: {
    ...
    thumbnailSrc: 'https://res.cloudinary.com/drd6p33en/image/upload/q_auto:best,f_auto/v1782210430/Dexus_case_study_image_tpyxmq.png',
  ...
  caseStudies: [
    {
      ...
      tags:         'Research · Information Architecture · Design Systems',
      description:  "A $51.5 billion real estate portfolio. A website that couldn't tell an investor from a tenant.",
      thumbnailSrc: 'https://res.cloudinary.com/drd6p33en/image/upload/q_auto:best,f_auto/v1782210430/Dexus_case_study_image_tpyxmq.png' as string | null,
      thumbnailAlt: 'Dexus digital transformation project thumbnail',
      slug:         'dexus',
    },
    {
...
export const caseStudyPages: Record<string, CaseStudyPage> = {
  dexus: {
    ...
    tags:         'Research · Information Architecture · Design Systems',
    description:  "A $51.5 billion real estate portfolio. A website that couldn't tell an investor from a tenant.",
    heroImageSrc: 'https://res.cloudinary.com/drd6p33en/image/upload/q_auto:best,f_auto/v1782210430/Dexus_case_study_image_tpyxmq.png',
    ...
    designItems: [
      {
        ...
        imageSrc:     'https://res.cloudinary.com/drd6p33en/image/upload/q_auto:best,f_auto/v1782328154/the_marketing_team_had_a_vision._they_just_needed_help_making_the_case_1_bckxqk.png',
      ...
      },
      {
        ...
        imageSrc:     'https://res.cloudinary.com/drd6p33en/image/upload/q_auto:best,f_auto/v1782328154/interaction_design_as_a_brand_signal_1_xg2zl2.png',
      ...
      },
      {
        ...
        imageSrc:     'https://res.cloudinary.com/drd6p33en/image/upload/q_auto:best,f_auto/v1782328153/one_system._twenty-six_sites._built_in_the_wrong_order._cyss1d.png',
    ...
    imageGrid: [
      { src: 'https://res.cloudinary.com/drd6p33en/image/upload/q_auto:best,f_auto/v1782329439/Dexus_image_grid_design_1_eh0xmi.png', alt: 'Dexus homepage redesign' },
      { src: 'https://res.cloudinary.com/drd6p33en/image/upload/q_auto:best,f_auto/v1782329437/Dexus_image_grid_design_2_w2ekvx.png', alt: 'Dexus investment platform design' },
      { src: 'https://res.cloudinary.com/drd6p33en/image/upload/q_auto:best,f_auto/v1782329437/Dexus_image_grid_design_3_k5nhuw.png', alt: 'Dexus property listing page' },
      { src: 'https://res.cloudinary.com/drd6p33en/image/upload/q_auto:best,f_auto/v1782329439/Dexus_image_grid_design_4_kaewbf.png', alt: 'Dexus retail site design' },
      { src: 'https://res.cloudinary.com/drd6p33en/image/upload/q_auto:best,f_auto/v1782329439/Dexus_image_grid_design_5_fexqul.png', alt: 'Dexus retailer portal' },
      { src: 'https://res.cloudinary.com/drd6p33en/image/upload/q_auto:best,f_auto/v1782329439/Dexus_image_grid_design_6_xsomcu.png', alt: 'Dexus commercial property site' },
      { src: 'https://res.cloudinary.com/drd6p33en/image/upload/q_auto:best,f_auto/v1782329440/Dexus_image_grid_design_7_oqtjp6.png', alt: 'Dexus premium property microsite' },
      { src: 'https://res.cloudinary.com/drd6p33en/image/upload/q_auto:best,f_auto/v1782329441/Dexus_image_grid_design_8_xnlwwo.png', alt: 'Dexus One Bligh Sydney site' },
    ],
    quotes: [
      {
